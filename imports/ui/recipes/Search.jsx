    ...
    render() {
        const form = (
            <div>
                ...
                <RecipeForm title={this.state.titulo} setTitle={this.handleTitle.bind(this)} ingredients={this.state.ingredients} addIngredient={this.addIngredient.bind(this)} deleteIngredient={this.deleteIngredient.bind(this)} addType={this.addType.bind(this)}/>
        ...
        const busquedaCompleta = (
            <div className="buscar">
                <h2 className="bold head orange" onClick={() => {
                    this.paginaBusqueda()
                }}>
                    ...
                    return (
                        <div key={recipe.title}>
                            <Recipe recipe={recipe} ingredients={recipe.Ingredients} username={recipe.username} title={recipe.title} showDelete={false}/>
                        </div>
                    );
                })}
            </div>
